...
public class PlayerController : MonoBehaviour
{
    ...
    private void Update_Input()
    {
        ...
        float xSpeed = xDelta * m_Speed * Time.deltaTime;
        float ySpeed = yDelta * m_Speed * Time.deltaTime;

        // 리지드바디의 속도에 할당
        m_Rigidbody.velocity = new Vector3(xSpeed, 0, ySpeed);
    }
